<?php
	...
	Config::$dbConn['sys'] = Config::$path['app'].'core/sysDBconn.php'; //holds a static method call for root level database access
	Config::$dbConn['user'] = Config::$path['app'].'core/userDBconn.php'; //holds a static method call for basic level database access
?>
