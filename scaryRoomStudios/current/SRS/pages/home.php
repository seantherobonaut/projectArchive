...
<p class="s2" style="background-color: #504F4E;margin:0px;padding:5px;width:100%;border:none;font-weight: normal;color:white">
...
<p class="s2" id="vidtext" style="border:none">Check out our original visual produced by @caliwoods_v</p>
<iframe id="hectorVideo" src="https://www.youtube.com/embed/LmNO_UHz8uw?modestbranding=1&rel=0&autohide=0&showinfo=0" frameborder="0" allowfullscreen style="display:block;margin:auto;border:1px solid #ccc;border-width:1px 0px;padding:10px 0px;"></iframe>
...
<p class="s2" style="margin-top:0px;border-top:0px;">Welcome to Scary Room Studios!</p>
...
<div style="padding:15px 35px 15px 10px">
	<img id="brandon" style="margin-bottom:20px" src="SRS/images/content/bdawg.png" />
	<div>
